...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ClientReceiver_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ClientReceiver_t qt_meta_stringdata_ClientReceiver = {
    {
QT_MOC_LITERAL(0, 0, 14), // "ClientReceiver"
QT_MOC_LITERAL(1, 15, 15), // "messageReceived"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 3) // "msg"

    },
    "ClientReceiver\0messageReceived\0\0msg"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_ClientReceiver[] = {
...
void ClientReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ClientReceiver::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientReceiver::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ClientReceiver::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_ClientReceiver.data,
...
// SIGNAL 0
void ClientReceiver::messageReceived(QString _t1)
{
